    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('expert', 'Expert'), ('admin', 'Admin'), ('initiator', 'Initiator'), ('project office', 'Project Office')], default='админ', max_length=14, verbose_name='Роль')),
            ],
        ),
        migrations.CreateModel(
            name='User',
